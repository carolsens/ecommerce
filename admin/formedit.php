...
<body class="nav-md">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<select class="form-control" name="local_pagina_inicial" >
													<option></option>
													<option value="carouselnews" <?php if($product->local_pagina_inicial == 'carouselnews'): ?>selected<?php endif; ?>>Carrossel News</option>
													<option value="carouselsale" <?php if($product->local_pagina_inicial == 'carouselsale'): ?>selected<?php endif; ?>>Carrossel Promoções</option>
													<option value="carouselorder" <?php if($product->local_pagina_inicial == 'carouselorder'): ?>selected<?php endif; ?>>Carrossel Mais Vendidos</option>											
												</select>
											</div>
										</div>
	...
	<script src="../admin/scriptbackend.js"></script>
	<script src="../admin/assets/libs/jquery.maskMoney.min.js"></script>
